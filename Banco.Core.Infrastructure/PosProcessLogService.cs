...
public sealed class PosProcessLogService : IPosProcessLogService
{
    ...
    private static string ResolveLogFileName(string source)
    {
        return source switch
        {
            ...
            "BackupConfigurationViewModel" => "Backup.log",
            "RestoreConfigurationViewModel" => "Backup.log",
            "BackupImportViewModel" => "Backup.log",
            "GestionaleBackupExportService" => "Backup.log",
            "GestionaleBackupImportService" => "Backup.log",
            "WindowsBackupScheduleService" => "Backup.log",
            "ScheduledBackupRunner" => "Backup.log",
