...
public sealed class ShellNavigationRegistry : INavigationRegistry
{
    ...
    [
        new("banco", "Banco", "IconBanco", 0, "#4F86DC"),
        new("magazzino", "Magazzino", "IconFolder", 1, "#4E748F"),
        new("documenti", "Documenti", "IconDocumenti", 2, "#C47F1F"),
        new("anagrafiche", "Anagrafiche", "IconPoints", 3, "#3FA06E"),
        new("contabilita", "Contabilita`", "IconCash", 4, "#B55454"),
        new("impostazioni", "Impostazioni", "IconSettings", 5, "#7059B8")
    ];

    private static readonly IReadOnlyList<NavigationDestinationDefinition> Destinations =
    [
        new("banco.vendita", "Vendita al Banco", "workspace.banco", SupportsMultipleTabs: true),
        ...
        new("impostazioni.db", "Configurazioni generali", "workspace.configurazioni-generali"),
    ...
    [
        new("banco.vendita", "Vendita al Banco", "banco", "banco-main", "banco.vendita", NavigationEntryAvailability.Available, 0, true, true, ["banco", "nuova vendita"], ["cassa", "vendita al banco"], false, "#4F86DC", false, false, true, false, "Banco"),
        new("banco.nuovo-documento", "Nuovo documento", "banco", "banco-operazioni", null, NavigationEntryAvailability.DisabledPhase, 1, true, false, [], [], true, "#4F86DC", false, false, false, false, "Operazioni"),
        ...
        new("banco.storico-fidelity", "Storico fidelity", "banco", "banco-fidelity", null, NavigationEntryAvailability.DisabledPhase, 7, true, false, [], [], true, "#3FA06E", false, false, false, false, "Fidelity"),
        ...
        new("magazzino.articolo", "Articolo magazzino", "magazzino", "magazzino-main", "magazzino.articolo", NavigationEntryAvailability.Available, 1, true, true, ["articolo", "magazzino"], ["parametri articolo", "confezione", "riordino articolo"], true, "#4E748F", true, true, true, true, "Magazzino"),
        ...
        new("impostazioni.fastreport", "FastReport", "impostazioni", "impostazioni-core", "impostazioni.fastreport", NavigationEntryAvailability.Available, 1, true, true, ["fastreport", "layout"], ["designer stampa", "runtime fastreport", "studio fastreport"], true, "#7059B8", true, true, true, true, "Configurazioni"),
        new("impostazioni.pos", "Configurazione POS", "impostazioni", "impostazioni-core", "impostazioni.pos", NavigationEntryAvailability.Available, 2, true, true, ["pos", "nexi"], ["smartpos", "registratore"], true, "#7059B8", true, true, true, true, "Configurazioni"),
        new("impostazioni.fiscale", "Configurazione fiscale", "impostazioni", "impostazioni-core", "impostazioni.fiscale", NavigationEntryAvailability.Available, 3, true, true, ["fiscale", "winecr"], ["registratore", "fiscalizzazione"], true, "#7059B8", true, true, true, true, "Configurazioni"),
        new("impostazioni.temi", "Gestione temi", "impostazioni", "impostazioni-layout", "impostazioni.temi", NavigationEntryAvailability.Available, 4, true, true, ["temi", "colori"], ["aspetto", "palette"], true, "#7059B8", true, true, true, true, "Aspetto"),
        new("impostazioni.diagnostica", "Diagnostica / Percorsi", "impostazioni", "impostazioni-tools", "impostazioni.diagnostica", NavigationEntryAvailability.Available, 5, true, true, ["diagnostica", "percorsi"], ["percorsi file", "log", "cartelle"], true, "#7059B8", true, true, true, true, "Strumenti"),
        new("impostazioni.backup", "Importa backup", "impostazioni", "impostazioni-tools", "impostazioni.backup", NavigationEntryAvailability.Available, 6, true, true, ["backup", "ripristino"], ["import backup"], true, "#7059B8", true, true, true, true, "Strumenti")
    ];
